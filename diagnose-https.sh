...
if [ -f /etc/letsencrypt/live/preinscription.sbcgroupe.ca/fullchain.pem ]; then
    ...
    ls -lh /etc/letsencrypt/live/preinscription.sbcgroupe.ca/fullchain.pem
else
...
if [ -f /etc/letsencrypt/live/preinscription.sbcgroupe.ca/privkey.pem ]; then
    ...
    ls -lh /etc/letsencrypt/live/preinscription.sbcgroupe.ca/privkey.pem
else
...
echo "8. Test de connexion locale sur le port 443"
echo "------------------------------------------"
if command -v curl &> /dev/null; then
    echo "Test HTTPS local:"
...
echo "9. Vérification de la configuration chargée"
echo "------------------------------------------"
