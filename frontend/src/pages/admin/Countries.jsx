...
import { FiPlus, FiEdit, FiTrash2, FiGlobe, FiSave, FiX } from 'react-icons/fi'
...
const AdminCountries = () => {
  ...
  const fetchCountries = async () => {
    try {
      const response = await api.get('/countries/all?all=true')
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.code || !formData.code.trim()) {
      toast.error('Le code du pays est requis (3 lettres)')
      setLoading(false)
      return
    }
    if (formData.code.length !== 3) {
      toast.error('Le code doit contenir exactement 3 lettres')
      setLoading(false)
      return
    }
    ...
    try {
      ...
      if (editingCountry) {
        ...
        data._method = 'PUT'
        response = await api.post(`/countries/${editingCountry.id}`, data)
        ...
        response = await api.post('/countries', data)
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-neutral-600">
              Configurez les pays disponibles sur la page d'accueil
            </p>
          </div>
          <Button
            onClick={() => {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {countries.length === 0 ? (
            <div className="col-span-full text-center py-12">
              <FiGlobe className="mx-auto text-6xl text-neutral-300 mb-4" />
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Input
                  ...
                  placeholder="Ex: Destination d'excellence"
                  helperText="Sous-titre qui apparaîtra sous le nom du pays sur la page d'accueil"
                />
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    rows="4"
                    placeholder="Description du pays et des opportunités d'études..."
                    className="input resize-none"
                  />
                  <p className="form-helper">
                    Description qui apparaîtra sur la carte du pays
                  </p>
                </div>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    rows="6"
                    placeholder="Liste des conditions d'éligibilité pour étudier dans ce pays..."
                    className="input resize-none"
                  />
                  <p className="form-helper">
                    Ces conditions apparaîtront dans la modal de détails du pays
                  </p>
                </div>
                ...
                <div className="flex items-center space-x-3 p-4 bg-neutral-50 rounded-lg">
                  ...
                  <label htmlFor="is_active" className="text-sm font-medium text-neutral-700 cursor-pointer">
                    Afficher ce pays sur la page d'accueil
                  </label>
                </div>
